...
- [`scripts/prepare-vps-host.sh`](scripts/prepare-vps-host.sh)
  chuẩn bị VPS trắng thành môi trường build/run phù hợp cho GEN WAF
...
Với VPS trắng chưa có môi trường:
...
- [Tham chiếu cấu hình đầy đủ](docs/CONFIG_FULL_REFERENCE.vi.md)
